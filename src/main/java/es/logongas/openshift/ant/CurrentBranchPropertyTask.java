 ...
 * @author Lorenzo
 */
public class CurrentBranchPropertyTask extends Task {
    ...
    public void execute() throws BuildException {
        String currentBranch = openShiftUtil.getCurrentBranch(getRepositoryPath());

        getProject().setNewProperty(getName(), currentBranch);
    }

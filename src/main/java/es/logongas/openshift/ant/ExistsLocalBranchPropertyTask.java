 ...
 * @author Lorenzo
 */
public class ExistsLocalBranchPropertyTask extends Task {
    ...
    public void execute() throws BuildException {
        boolean existsLocalBranch = openShiftUtil.existsLocalBranch(getRepositoryPath(), getBranchName());

        getProject().setNewProperty(getName(), existsLocalBranch+"");
    }
